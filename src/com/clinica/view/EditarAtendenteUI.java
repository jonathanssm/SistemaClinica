 ...
 * @author Jonathan
 */
public class EditarAtendenteUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblSetor.setText("CODIGO DO SETOR:");
        lblSetor.setToolTipText("");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            ...
            Logger.getLogger(EditarAtendenteUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (boxSexo.getSelectedItem().toString().equalsIgnoreCase("*sexo") || txtNome.getText().isEmpty() || txtRG.getText().isEmpty() || txtDNASC.getText().isEmpty()
            ...
            try {
                a.update(Long.parseLong(txtCPF.getText().replace(".", "").replace("-", "")), txtRG.getText().replace(".", "").replace("-", "").replace(" ", ""), txtNome.getText(), txtDNASC.getText(), txtEmail.getText(), sexo,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarAtendenteUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarAtendenteUI().setVisible(true);
            }
        });
    }
